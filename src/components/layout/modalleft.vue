<template>
<div>
    <button class="btn btn-green btn-lg pull-right" 
   data-target="#modalSlideLeft" data-toggle="modal">Generate</button>
   
   <div class="modal fade slide-right open" id="modalSlideLeft" tabindex="-1" role="dialog" 
   style="display: block;">
